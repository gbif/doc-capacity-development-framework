...
<1>The ability to manage, standardize and publish biodiversity data
...
<1>The ability to analyse and use biodiversity data accessible through GBIF in scientific research and decision making
